    ...
    <div className="beerreview-all">
      ...
      >
        <Toolbar sx={{
          ...
          <Box sx={{ height: 60}}>
            <Typography component="legend" sx={{fontSize : 20, fontWeight: 'bold', textAlign: "center"}}>{beerName} 평점</Typography>
            <StyledRating
              value={rankValue}
              precision={1}
          ...
          placeholder="자유롭게 이야기해주세요"></textarea>
          <button
          className="add-comment__dialogbtn"
          >이렇게 평가할래요!</button>
        </Toolbar>
      </Dialog>
